...
import { BarChart3, UserPlus, Package, Globe, ArrowDownRight, ArrowUpRight } from "lucide-react";

const overviewData = [
  { name: "Ad Spend", value: "$234,890", change: -4.1, icon: BarChart3 },
  { name: "New Signups", value: "12,345", change: 6.9, icon: UserPlus },
  { name: "Shipments", value: "7,654", change: 2.8, icon: Package },
  { name: "Global Reach", value: "98 Countries", change: 10.2, icon: Globe },
];
